...
; use IPython
(setq-default py-shell-name "/Users/ha/anaconda/bin/ipython")
...
(when (load "flymake" t)
  (defun flymake-pyflakes-init ()
    (let* ((temp-file (flymake-init-create-temp-buffer-copy
      ...
      (list "/Users/ha/anaconda/bin/pychecker" (list local-file))))
...
(setenv "PYTHONPATH"
 (concat 
  "/Users/ha/anaconda/lib/python2.7/site-packages:"
